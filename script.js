const alunos = [
  ...
  { id: 34, nome: `Matheus Correia`, turma: `GTI A`, faltas: 10, notaFinal: 4.7 },
  ...
  { id: 44, nome: `Wesley Nascimento`, turma: `GTI A`, faltas: 6, notaFinal: 6.3 },
  ...
  { id: 50, nome: `Emanuelly Torres`, turma: `GTI B`, faltas: 0, notaFinal: 9.7 },
  ...
  { id: 57, nome: `Lívia Figueiredo`, turma: `GTI B`, faltas: 1, notaFinal: 9.3 },
  { id: 58, nome: `Miguel Siqueira`, turma: `GTI B`, faltas: 5, notaFinal: 7.4 },
...
function criarCardAluno(aluno) {
  return `<div class="card-aluno">
          ...
          <div class="card-info">
            <p><strong>Nota final:</strong> ${aluno.notaFinal}</p>
...
function aprovado() {
  listaAlunos.innerHTML = ``;
  const alunosAprovados = alunos.filter((aluno) => aluno.notaFinal >= 7);
  exibirAlunos(alunosAprovados);
}

function reprovado() {
  listaAlunos.innerHTML = ``;
  const alunosReprovados = alunos.filter((aluno) => aluno.notaFinal < 7);
